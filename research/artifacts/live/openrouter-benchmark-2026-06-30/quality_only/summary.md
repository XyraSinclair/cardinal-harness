...
Policy: `quality_only_opus_46`
Run directory: `/Users/xyra/Documents/labs/cardinal-harness/artifacts/live/openrouter-benchmark-2026-06-30/quality_only`
Cases: 3
Comparisons used: 153
Cached comparisons: 0
Refusals: 0
Provider input tokens: 75780
Provider output tokens: 4136
Provider cost: $0.482300
Trace cost estimate rows: 0

| Case | Model used | Stop | Used/Budget | Cached | Refused | Cost USD | Top entities |
|---|---|---|---:|---:|---:|---:|---|
| `public_evidence_surfaces` | `anthropic/claude-opus-4.6` | `no_new_pairs` | 45/72 | 0 | 0 | $0.143400 | worked_example, readme, evaluation_doc |
| `model_policy_live_routing` | `anthropic/claude-opus-4.6` | `no_new_pairs` | 45/72 | 0 | 0 | $0.143750 | frontier_ladder_2026_06, qwen_3_7_max |
