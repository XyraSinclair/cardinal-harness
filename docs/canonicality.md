...
| Rendered judge bytes are content-addressed directly; trace identity matches the actual instrument; successful rows replay the exact solver observation; answer label and payload position are independently measurable in all four cells before any default delimiter migration | **named-gap** — tracked in #54; immediate evidence-slug trace mismatch, observation-replay seam, deterministic double-delimiter experiment, and stop gates specified |
...
`notes/canonicalize-2026-07-09/defects.md`. Step 2: this file. Step 3
