...
| Successful rows replay the exact solver observation; answer label and payload position are independently measurable in all four cells before any default delimiter migration | **named-gap** — phases 2–3 of #54; replay/config identity and four-cell renderer remain |
