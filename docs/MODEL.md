...
This is the compact mathematical contract behind `llmsort`. `docs/ALGORITHM.md` gives the engineering rationale; this page states the objects, assumptions, and limits.
